...
class ChangeNullableFieldAtUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            $table->integer('catefories_id')->nullable()->change();
    ...
    {
        Schema::table('users', function (Blueprint $table) {
            $table->longtext('address1')->nullable(false)->change();
            $table->longtext('address2')->nullable(false)->change();
            ...
            $table->integer('catefories_id')->nullable(false)->change();
